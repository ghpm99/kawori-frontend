            ...
            <div className={styles["body"]}>
                ...
                <div>
                    <Carousel autoplay>
                        <div className={styles["content-carousel"]}>
                            <h3>Se divirta com o ranking de mensagens!</h3>
                        </div>
                        <div className={styles["content-carousel"]}>
                            <Link href="/facetexture">
                                <h3>Personalize sua seleção de personagem!</h3>
                            </Link>
                        </div>
                        <div className={styles["content-carousel"]}>
                            <img
                ...
                <div className={styles["card-container"]}>
                    <div className={styles["card"]}>
                        <h1>
                            Olá! Meu nome é Kawori e estou aqui para te auxiliar
                            com seu grupo no Discord.
                        </h1>
                    ...
                    <div className={styles["card"]}>
                        ...
                        <h1>
                            Possuo um sistema de Auto-Roles simples e facil de
                            utilizar.
                        </h1>
                    </div>
                    <div className={styles["card"]}>
                        <h1>
                            Também possuo varios comandos de interação e muito
                            mais!
                        </h1>
