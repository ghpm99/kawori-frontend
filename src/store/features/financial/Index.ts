...
export const financialSlice = createSlice({
    ...
    reducers: {
        ...
        changeVisibleModalContract: (
            ...
            state.contractDetail.modal[action.payload.modal].visible =
                action.payload.visible;
        },
        ...
        changeVisibleModalTag: (
            state: IFinancialStore,
            action: PayloadAction<PayloadChangeVisibleModalTagsAction>,
        ) => {
            state.tags.modal[action.payload.modal].visible =
                action.payload.visible;
        },
        ...
        changeSingleDataSourcePayoffPayments: (
            ...
            const index = state.payments.modal.payoff.data.findIndex(
                (item) => item.id === action.payload.id,
            );
        ...
        builder
            ...
            .addCase(fetchAllPayment.fulfilled, (state, action) => {
                ...
                state.payments.pagination.currentPage =
                    action.payload.response.data.current_page;
                state.payments.pagination.hasNext =
                    action.payload.response.data.has_next;
                state.payments.pagination.hasPrevious =
                    action.payload.response.data.has_previous;
                state.payments.pagination.totalPages =
                    action.payload.response.data.total_pages;
            ...
            .addCase(fetchPaymentReport.fulfilled, (state, action) => {
                ...
                state.paymentReport.data.countPayment =
                    action.payload.count.data;
                state.paymentReport.data.amountPayment =
                    action.payload.amount.data;
                state.paymentReport.data.amountPaymentOpen =
                    action.payload.amountOpen.data;
                state.paymentReport.data.amountPaymentClosed =
                    action.payload.amountClosed.data;
                state.paymentReport.data.invoiceByTag =
                    action.payload.amountByTag.data;
            ...
            .addCase(fetchAllContract.fulfilled, (state, action) => {
                ...
                state.contractDetail.contracts =
            ...
            .addCase(
                fetchContractInvoicesDetails.fulfilled,
                (state, action) => {
                    state.contractDetail.invoices.data =
                        action.payload.response.data.data;
                    ...
                    state.contractDetail.invoices.filters =
            ...
            .addCase(fetchInvoicePaymentsDetails.fulfilled, (state, action) => {
                state.invoiceDetail.payments.data =
                    action.payload.response.data.data;
