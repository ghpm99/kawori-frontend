...
export default function Home() {
    ...
    useEffect(() => {
        document.title = "Kawori Black Desert";
        ...
        <>
            <div className={styles["section"]}>
                ...
                <UserPanel
                    ...
                    links={[
                        { text: "Perfil", link: "/user" },
                        { text: "Facetexture", link: "/blackdesert/app/facetexture" },
                        { text: "Rank de Classes", link: "/blackdesert/app/rank" },
                    ]}
                />
            </div>
            <Divider />
