...
export const fetchAmountPaymentOpenReportThunk = createAsyncThunk("financial/fetchAmountPaymentOpenReportThunk", async () => {
    const response = await apiDjango.get("/financial/report/amount_payment_open");
    return response;
});

export const fetchAmountPaymentClosedReportThunk = createAsyncThunk("financial/fetchAmountPaymentClosedReportThunk", async () => {
    const response = await apiDjango.get("/financial/report/amount_payment_closed");
    return response;
});

export const fetchAmountInvoiceByTagReportThunk = createAsyncThunk("financial/fetchAmountInvoiceByTagReportThunk", async () => {
