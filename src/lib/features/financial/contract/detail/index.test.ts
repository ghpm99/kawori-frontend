...
describe("contractDetailSlice", () => {
    ...
    test("should handle changeVisibleModalContract", () => {
    ...
    test("should handle changeValueMergeModal", () => {
    ...
    test("should handle fetchContractDetails pending and fulfilled", async () => {
    ...
    test("should handle fetchContractInvoicesDetails pending and fulfilled", async () => {
        const mockResponse = {
            data: {
    ...
    test("should handle fetchContractInvoicesDetails rejected", async () => {
